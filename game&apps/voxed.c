...
voxed.exe: voxed.obj voxlap5.obj v5.obj kplib.obj winmain.obj voxed.c
	...
	del winmain.obj
voxed.obj:   voxed.c voxlap5.h sysmain.h; cl /c /J /TP voxed.c     /Ox /Ob2 /G6Fy /Gs /ML
voxlap5.obj: voxlap5.c voxlap5.h;         cl /c /J /TP voxlap5.c   /Ox /Ob2 /G6Fy /Gs /ML
v5.obj:      v5.asm;                      ml /c /coff v5.asm
kplib.obj:   kplib.c;                     cl /c /J /TP kplib.c     /Ox /Ob2 /G6Fy /Gs /ML
winmain.obj: winmain.cpp;                 cl /c /J /TP winmain.cpp /Ox /Ob2 /G6Fy /Gs /ML /DNOSOUND
!if 0
#endif
...
//-------------------------------------------------------
	...
	/*if (keystatus[0x45]) //Numlock
	{
		...
		if (keystatus[0x1d]|keystatus[0x9d])
		{
			...
			{
				vx5.mipscandist += (vx5.mipscandist>>2);
				if (vx5.mipscandist > 768) vx5.mipscandist = 768;
			}
		}
		else
		{
			...
			{
				vx5.maxscandist += (vx5.maxscandist>>2);
				if (vx5.maxscandist > 768) vx5.maxscandist = 768;
			}
		}
